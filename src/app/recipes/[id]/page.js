    ...
    <main style={{ maxWidth: 'var(--maxw)', margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
      ...
      <div style={{
        ...
        {ingredients.length > 0 && (
          <div>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1.2rem' }}>Ingredients</h2>
        ...
        {recipe.instructions && (
          <div>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1.2rem' }}>Instructions</h2>
            <div
      ...
      {similar.length > 0 && (
        <section>
          <h2 style={{ fontSize: '1.8rem', marginBottom: '0.4rem' }}>You might also like</h2>
          <p style={{ color: 'var(--ink-soft)', marginBottom: '1.8rem' }}>More recipes from the same category.</p>
